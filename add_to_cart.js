...
function addCart(productImg,productName,productPrice){
  ...
  for (var i=0;i<cartItem.length;i++){
      var productT = document.querySelectorAll('.heading')
  ...
  if(countItem > 0) {
      ...
      var trcontent = '<tr><td><img src="'+productImg+'" alt="1" class="cart-ads1"/> <h3 class="heading">'+productName+'</h3></td> <td><p>$ <span class ="price">'+productPrice+'</span></p></td> <td> <input id="'+productName+'" class="cart-quantity-input" type="number" step="1" value="1" min="1"></input></td> <td><span class= "btn-del-item-cart">Xoá</span></td> </tr>'
